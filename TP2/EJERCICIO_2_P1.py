...
# --- Función para determinar puntos del rectangulo ---
...
# --- Función para determinar puntos promedios ---
def distancia(p1, p2):
    return ((p1[0]-p2[0])**2 + (p1[1]-p2[1])**2) ** 0.5

# --- Función para ordenar los puntos: superior izquierda, superior derecha, inferior derecha, inferior izquierda
...
# --- Función main ---
def procesar_imagen(ruta, debug=False):
    ...
    # FILTRADO DE LINEAS SEGUN DIFERENTES CRITERIOS
    ...
    for _, linea in lineas_con_longitud:
        ...
        # Si al menos un extremo está dentro del área circular, filtrarlo
        if dist1 > radio and dist2 > radio:
    ...
    # EXTENDER LINEAS PARA ASEGURAR INTERSECCION
    estirar = 1000
    ...
    # CALCULAR PUNTOS UNICOS PRODUCTO DE LA INTERSECCION DE LAS LINEAS
    puntos_interseccion = []
    ...
    # PREPARAMOS Y EJECUTAMOS LA HOMOGRAFIA
...
# --- Función de exportación y rotación---
def guardar_imagen_procesada(ruta, imagen):
    ...
    if alto > ancho:
        imagen = imutils.rotate_bound(imagen, 90)
...
for i in range(1, 11):
    # Iterar letras de 'a' a 'd'
    for letra in string.ascii_lowercase[:4]:  # ['a', 'b', 'c', 'd']
